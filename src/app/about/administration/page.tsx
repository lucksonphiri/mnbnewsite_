...
<section className="py-16"><div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-3 gap-10"><div className="lg:col-span-2">
  ...
  <p className="mt-4 text-gray-600 text-lg leading-8">The administration of MNB College is responsible for the day-to-day management of the institution. It is led by the Founders, Board of Directors, Head of School, and various departmental heads. The administration ensures effective teaching and learning, student welfare, financial management, staff development, and the smooth running of all school activities.</p><br></br>
